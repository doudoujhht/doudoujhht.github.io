...
!(function (e, t) {
            ...
            (t = [
                    ...
                    value: function () {
                        ...
                        (i.className = n.config.containerClass),
                            n.config.useContainerInlineStyles &&
                                ...
                                (i.style.width = "".concat(2 * n.radius, "px")),
                                (i.style.height = "".concat(2 * n.radius, "px"))),
                            (n.items = []),
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        (e = Math.acos((2 * e + 1) / n - 1)),
                            (n = Math.sqrt((n + 1) * Math.PI) * e);
                        return {
                    ...
                    value: function () {
                        ...
                        (n.active = !1),
                            ...
                            o._on(n.keep ? window : n.$el, "mousemove", function (e) {
                                ...
                                (n.mouseX = (e.clientX - (t.left + t.width / 2)) / 5),
                                    (n.mouseY = (e.clientY - (t.top + t.height / 2)) / 5);
                            }),
                            n._next(),
                    ...
                    value: function () {
                        ...
                        r.paused ||
                            (r.keep ||
                                r.active ||
                                ((r.mouseX =
                                    Math.abs(r.mouseX - r.mouseX0) < 1
                                        ? r.mouseX0
                                        : (r.mouseX + r.mouseX0) / 2),
                                (r.mouseY =
                                    Math.abs(r.mouseY - r.mouseY0) < 1
                                        ? r.mouseY0
                                        : (r.mouseY + r.mouseY0) / 2)),
                            (e =
                                -(Math.min(Math.max(-r.mouseY, -r.size), r.size) / r.radius) *
                                r.maxSpeed),
                            (t =
                                (Math.min(Math.max(-r.mouseX, -r.size), r.size) / r.radius) *
                                r.maxSpeed),
                                ...
                                r.items.forEach(function (e) {
                                    ...
                                    (o = (1 < (o = t * t - 0.25) ? 1 : o).toFixed(3)),
                                        ...
                                        (e = "translate3d("
                                            ...
                                            .concat(t, "px, 0) scale(")
                                            .concat(e.scale, ")"));
                                    (n.style.WebkitTransform = e),
                                        (n.style.MozTransform = e),
                                        (n.style.OTransform = e),
                                        (n.style.transform = e),
                                        (n.style.filter = "alpha(opacity=".concat(100 * o, ")")),
                                        (n.style.opacity = o);
                                })));
                    },
                },
                    ...
                    value: function (e) {
                        ...
                        (i.texts = e || []),
                            i.texts.forEach(function (e, t) {
                                var n = i.items[t];
                                n ||
                                    (a((n = i._createTextItem(e, t)), i._computePosition(t, !0)),
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        -1 !== e && o.list.splice(e, 1),
                            t.$container && t.$el && t.$container.removeChild(t.$el);
                    },
                },
                {
                    key: "pause",
    ...
    (o.list = []),
        ...
        (o._getMaxSpeed = function (e) {
            return { slow: 0.5, normal: 1, fast: 3 }[e] || e;
        }),
        (o._getInitSpeed = function (e) {
            return { slow: 16, normal: 32, fast: 160 }[e] || e;
        });
